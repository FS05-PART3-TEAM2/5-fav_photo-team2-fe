...
import { SectionTitle } from "../../detail/SectionTitle";
...
import { PurchaseAmountInput } from "../../detail/consumer/PurchaseAmountInput";
...
export const SellerCardDetail: React.FC<CardDetailProps> = ({ data }) => {
